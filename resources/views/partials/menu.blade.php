        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('user_management_access')
                    <li class="nav-item has-treeview {{ request()->is("admin/users*") ? "menu-open" : "" }} {{ request()->is("admin/roles*") ? "menu-open" : "" }} {{ request()->is("admin/permissions*") ? "menu-open" : "" }} {{ request()->is("admin/subscribtions*") ? "menu-open" : "" }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @endcan
                            @can('subscribtion_access')
                                <li class="nav-item">
                                    <a href="{{ route("admin.subscribtions.index") }}" class="nav-link {{ request()->is("admin/subscribtions") || request()->is("admin/subscribtions/*") ? "active" : "" }}">
