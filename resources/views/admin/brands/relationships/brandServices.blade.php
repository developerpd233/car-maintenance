    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-brandServices">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.service.fields.last_appointment') }}
                            </th>
                            <th>
                                {{ trans('cruds.service.fields.branch') }}
                            </th>
                            <th>
                                {{ trans('cruds.service.fields.brand') }}
                            </th>
                            <th>
                                {{ trans('cruds.service.fields.model_year') }}
                            </th>
                            <th>
                                {{ trans('cruds.service.fields.mileage') }}
                            </th>
                            <th>
                                {{ trans('cruds.service.fields.working_time') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach($services as $key => $service)
                            <tr data-entry-id="{{ $service->id }}">
                                ...
                                <td>
                                    @foreach($service->branches as $key => $item)
                                        <span class="badge badge-info">{{ $item->name }}</span>
                                    @endforeach
                                </td>
                                <td>
                                    @foreach($service->brands as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-brandServices:not(.ajaxTable)').DataTable({ buttons: dtButtons })
